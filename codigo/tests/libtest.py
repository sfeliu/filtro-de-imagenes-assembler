...
corridas = [
    {'filtro': 'blit', 'tolerancia': 0, 'params': ''},
    {'filtro': 'monocromatizar_inf', 'tolerancia': 5, 'params': '128.0'},
    {'filtro': 'ondas', 'tolerancia': 5, 'params': '100 200'},
    {'filtro': 'temperature', 'tolerancia': 5, 'params': ''},
    {'filtro': 'edge', 'tolerancia': 10, 'params': ''}
]
